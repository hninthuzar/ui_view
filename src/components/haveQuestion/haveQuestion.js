...
import './haveQuestion.scss';
import bgimg1 from './img/hq-bgimg1.png';
import bgimg2 from './img/hq-bgimg2.png';
import bgimg3 from './img/hq-bgimg3.png';

function HaveQuestion (props) {
  ...
  return(
    <section className="relative bg-[#F2FBFF] haveQuestion">
      <div className='z-10 relative py-[60px] sm:py-20 xl:py-[100px] mx-auto containerv2'>
        <h3 className='text-center mb-9 sm:mb-[45px] text-blackz text-2xl sm:text-3xl 3xl:text-[2.375rem] leading[38px] sm:leading-[48px] 3xl:leading-[56px] max-w-[470px] mx-auto'>
        ...
        <div className='w-full text-center'>
          <a href='#' className='mx-auto text-sm sm:text-[0.938rem] flex items-center justify-center rounded-full w-[198px] h-[45px] lg:h-[50px] bg-dangerz text-white'>
            <span className='mr-[10px]'>Contact Us Now</span>
      ...
      <div className='absolute bottom-0 left-0 w-auto h-auto max-w-[150px] xsm:max-w-[200px] md:max-w-[250px] xl:max-w-[300px] 4xl:max-w-[350px]'>
        <img src={bgimg1} alt="bgimg1" className=''/>
      </div>
      <div className='absolute top-0 right-0 w-auto h-auto max-w-[100px] xsm:max-w-[120px] md:max-w-[150px] xl:max-w-[180px] 4xl:max-w-[200px]'>
        <img src={bgimg2} alt="bgimg2" className=''/>
      </div>
      <div className='absolute bottom-0 right-[20%] w-auto h-auto max-w-10 xsm:max-w-[50px] md:max-w-[70px] 4xl:max-w-[90px]'>
        <img src={bgimg3} alt="bgimg2" className=''/>
      </div>
    </section>
  )
}
